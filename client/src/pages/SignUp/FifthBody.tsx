	...
	return (
		<div className='max-w-xl sm:text-center mx-auto px-8 sm:px-16'>
			<img
				src='/images/lock.png'
				alt='lock'
				className='h-12 my-12 sm:mx-auto'
			/>
			<p className='text-sm'>
				STEP <b>3</b> OF <b>3</b>
			</p>
			<h3 className='text-3xl font-bold'>Set up your payment</h3>
			<h4 className='text-lg my-2 w-7/12 sm:w-6/12 sm:mx-auto'>
			...
			<div className='flex justify-end mt-4'>
				<p>Secure Server</p>
				<svg id='secure-server-icon' viewBox='0 0 12 16' className='w-3 ml-1'>
					<g fill='#FFB53F'>
			...
			>
				...
				<img
					src='/icons/arrow_forward_neutral.svg'
					alt='arrow_forward_neutral'
					className='h-8'
				/>
			</div>
		</div>
