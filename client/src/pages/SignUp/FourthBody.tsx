		...
		<div className='max-w-4xl mt-8 px-8 mx-auto'>
			...
			<div className='flex flex-col sm:flex-row mb-5 sticky top-0'>
				...
				<ul className='grid grid-cols-4 gap-2 mb-10 flex-1'>
					<li className='relative bg-red-400 text-white aspect-square text-sm font-semibold rounded-sm flex justify-center items-center'>
						Mobile
					</li>
					<li className='relative bg-red-400 text-white aspect-square text-sm font-semibold rounded-sm flex justify-center items-center'>
						Basic
					...
					<li className='relative bg-red-600 text-white aspect-square text-sm font-semibold rounded-sm flex justify-center items-center after:absolute after:h-10 after:w-10 after:rotate-45 after:-bottom-3 after:left-0 after:right-0 after:mx-auto after:bg-red-600 after:-z-10'>
						Premium
					</li>
				</ul>
			</div>
			<div className='flex flex-col sm:flex-row border-b mb-5'>
				...
				<ul className='grid grid-cols-4 gap-2 flex-1 mb-5 text-sm sm:text-base'>
					<li className='text-center font-semibold text-neutral-500'>
						70,000 <u>đ</u>
					</li>
					<li className='text-center font-semibold text-neutral-500'>
						180,000 <u>đ</u>
					...
					<li className='text-center font-semibold text-red-600'>
						260,000 <u>đ</u>
					</li>
				</ul>
			</div>
			<div className='flex flex-col sm:flex-row border-b mb-5'>
				...
				<ul className='grid grid-cols-4 gap-2 flex-1 mb-5 text-sm sm:text-base'>
					<li className='text-center text-sm font-semibold text-neutral-500'>
						Good
					</li>
					<li className='text-center text-sm font-semibold text-neutral-500'>
						Good
					...
					<li className='text-center text-sm font-semibold text-red-600'>
						Best
					</li>
				</ul>
			</div>
			...
			<div className='flex justify-center items-center'>
				<button className='w-full max-w-md text-white bg-primary rounded mt-6 mb-40 py-3 text-3xl hover:bg-red-500'>
					Next
				</button>
			</div>
		</div>
